...
import (
	...
	evm2 "github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/evm"
	...
	"github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/fee"

	ica2 "github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/ica"
	...
	icahost "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/host"

	icacontroller "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/controller"

	ibcclienttypes "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/core/02-client/types"

	ibccommon "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/core/common"

	icamauthtypes "github.com/zhengjianfeng1103/fbc/x/icamauth/types"

	icacontrollertypes "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/controller/types"
	icahosttypes "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/host/types"

	"github.com/spf13/viper"

	icatypes "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/types"

	ibckeeper "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/core/keeper"

	authante "github.com/zhengjianfeng1103/fbc/libs/cosmos-sdk/x/auth/ante"
	icacontrollerkeeper "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/controller/keeper"
	icahostkeeper "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/27-interchain-accounts/host/keeper"
	ibcfee "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/29-fee"
	ibcfeekeeper "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/29-fee/keeper"
	...
	"github.com/zhengjianfeng1103/fbc/x/icamauth"
	icamauthkeeper "github.com/zhengjianfeng1103/fbc/x/icamauth/keeper"
	...
	"github.com/zhengjianfeng1103/fbc/app/refund"
	ethermint "github.com/zhengjianfeng1103/fbc/app/types"
	fbexchain "github.com/zhengjianfeng1103/fbc/app/types"
	"github.com/zhengjianfeng1103/fbc/app/utils/sanity"
	...
	govclient "github.com/zhengjianfeng1103/fbc/libs/cosmos-sdk/x/mint/client"
	...
	ibctransferkeeper "github.com/zhengjianfeng1103/fbc/libs/ibc-go/modules/apps/transfer/keeper"
	...
	"github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/capability"
	"github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/core"
	staking2 "github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/staking"
	"github.com/zhengjianfeng1103/fbc/libs/ibc-go/testing/simapp/adapter/transfer"
	...
	commonversion "github.com/zhengjianfeng1103/fbc/x/common/version"
	...
	wasmclient "github.com/zhengjianfeng1103/fbc/x/wasm/client"
)
...
func init() {
	...
	fbexchain.SetBech32Prefixes(config)
	fbexchain.SetBip44CoinType(config)
}
...
func NewSimApp(
	...
	app.AccountKeeper = auth.NewAccountKeeper(
		codecProxy.GetCdc(), keys[auth.StoreKey], keys[mpt.StoreKey], app.subspaces[auth.ModuleName], fbexchain.ProtoAccount,
	)
...
func updateGPOHandler(gpo *gasprice.Oracle) sdk.UpdateGPOHandler {
	return func(dynamicGpInfos []sdk.DynamicGasInfo) {
		if appconfig.GetFecConfig().GetDynamicGpMode() != fbexchain.MinimalGpMode {
...
func (app *SimApp) SetOption(req abci.RequestSetOption) (res abci.ResponseSetOption) {
	if req.Key == "CheckChainID" {
		if err := fbexchain.IsValidateChainIdWithGenesisHeight(req.Value); err != nil {
			app.Logger().Error(err.Error())
			panic(err)
		}
		err := fbexchain.SetChainId(req.Value)
		if err != nil {
			app.Logger().Error(err.Error())
			panic(err)
		}
...
func (app *SimApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	// if appconfig.GetFecConfig().GetEnableDynamicGp() {
	// 	GlobalGpIndex = CalBlockGasPriceIndex(app.blockGasPrice, appconfig.GetFecConfig().GetDynamicGpWeight())
